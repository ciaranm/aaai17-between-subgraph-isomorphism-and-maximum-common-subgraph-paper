...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}[scale=0.6]%[every node/.style={circle, inner sep=0.5mm,node
            ...
            \begin{scope}[xshift=2cm, yshift=-3cm, color=black]
            \node at (0, -0.5) {$T$};
            \node [fill, circle, inner sep=1.5pt] (a) at (0,0) {};
            \node [fill, circle, inner sep=1.5pt] (b) at (-1,1) {};
        ...
        \end{tikzpicture}
        \caption{Notice that $P$ would be isormorphic to a subgraph of $T$ if the middle vertex in the diamond is removed.}
