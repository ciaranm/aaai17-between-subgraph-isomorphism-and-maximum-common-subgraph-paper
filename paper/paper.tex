...
version show a similar but slightly weaker trend.) We look at the product of the domain sizes,
rather than the number of eliminations, as this better reflects the number of combinations remaining
to be considered.
