...
\begin{abstract}
    ...
    slightly weakened forms of certain invariants from subgraph isomorphism, while retaining their
    effectiveness. For small values of $k$, we solve this problem on most of the standard
