...
maximum common induced subgraph problem (we discuss the non-induced case in
\cref{section:definitions}). However, although
...
There are three easy ways we might try to approach this problem.
...
\cite{DBLP:conf/ijcai/McCreeshPT16}. All of these instances are available in a simple text
