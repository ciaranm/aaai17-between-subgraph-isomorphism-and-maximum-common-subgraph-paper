...
\end{multicols}
\vspace{0.5cm}% Be careful if you remove this! Something weird happens where the caption overlaps
% the algorithm due to algorithm2e and multicol[vlined] not being entirely happy with each other.
% If you take this out, please check the space between the algorithm and the caption very very
% carefully.
...
\begin{figure}[h!]% The ! is needed to avoid this being bumped forward a page
    \centering
