...
more than once. ?? A few sentences on how this works. It can easily be seen that this propagator
will always find Hall sets or failed Hall sets of size zero or one, but it may miss larger sets.
This propagation could create new effectively-unit domains; if so, we loop.
