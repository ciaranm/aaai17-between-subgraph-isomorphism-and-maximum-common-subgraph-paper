...
\begin{figure}
    ...
    \begin{tikzpicture}[every node/.style={circle, inner sep=0.5mm}]
        ...
        \node[draw=none,right of = b3,node distance=1mm, yshift=-2.5mm] {$t_{1}$};

        \node[draw=none, below of = b3, node distance=6mm] {$T_{1}$};
    ...
    \end{tikzpicture}\hspace{0.5cm}\begin{tikzpicture}[every node/.style={circle, inner sep=0.5mm}]
        ...
        \node[draw=none, below of = p, node distance=6mm] {$T_{2}$};
