...
plot \
    "../experiments/new-gpgnode-results/runtime-sequential-d2.data" u 3:($3>=1e6?1e-10:1) smooth cumulative w steps ti "$k=0$" at end lc 1, \
    "../experiments/new-gpgnode-results/runtime-sequential-d2.data" u 4:($4>=1e6?1e-10:1) smooth cumulative w steps ti "$k=1$" at end lc 2, \
...
plot \
    "../experiments/new-gpgnode-results/runtime-sequential-d2-induced.data" u 3:($3>=1e6?1e-10:1) smooth cumulative w steps ti "$k=0$" at end lc 1, \
    "../experiments/new-gpgnode-results/runtime-sequential-d2-induced.data" u 4:($4>=1e6?1e-10:1) smooth cumulative w steps ti "$k=1$" at end lc 2, \
