...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}[every node/.style={circle, inner sep=0.5mm,node distance=10mm,fill=black}]
            ...
            \node (ac2) [fill=gray!70,above left of = ab2,node distance=13mm,xshift=-2mm] {};
            ...
            \node (bc2) [fill=gray!70,above right of = bb2,node distance=13mm,xshift=2mm] {};
            ...
            \path[color=gray!70] (ac2) edge (ab2) edge (aa2)
