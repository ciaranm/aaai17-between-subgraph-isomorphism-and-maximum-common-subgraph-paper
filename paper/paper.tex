...
\begin{abstract}
    ...
    vertices from the pattern can be found in the target. This allows us to develop slightly
    weakened forms of certain invariants from subgraph isomorphism, retaining most of their
    effectiveness. For small values of $k$, we can solve this problem on most of the standard problem
